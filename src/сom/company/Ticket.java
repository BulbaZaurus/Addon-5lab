...
public class Ticket implements Comparable<Ticket>, Serializable {
    ...
    public static Ticket TicketBuilder(){
        ...
        Event event1 =new Event(id,sub_event_name,eventType,date);
        Ticket ticket =new Ticket(id_event,name,coordinates,price,sub_comment,refundable,ticketType,event1,creationDate);
        return  ticket;
    }
    ...
    public  static String TicketToString(Ticket ticket,boolean god){
        ...
        sb.append(ticket.creationDate.toString());
        sb.append(";");
